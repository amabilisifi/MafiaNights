...
public class  M {
    public static void main(String[] args) {
        ...
        System.out.println(gameState.getSilentPlayerInLastRound().getName());//doctor
        ...
        System.out.println(gameState.isDay());//true
        System.out.println(gameState.getWinners().size());//0
        System.out.println(gameState.getSilentPlayerInLastRound());//null
        ...
        System.out.println(detective.action(sniper));//NO_MAFIA
        gameState.nextDay();
        System.out.println(gameState.getAlivePlayers().size()); // 5
        System.out.println(gameState.getDeadPlayersInLastRound().size()); // 0
        gameState.nextNight();
